...
public static class GovernanceToolContract
{
    ...
    public const string PublishedCatalogVersion = "2026-09-08-v6";
    ...
    public const string ExecuteDescription =
        ...
        "ContractVersion=2.2; SchemaHash=f2cffdc0359f7a8e31b844908e848de2515470e5d19a34560f253eccff96ca3e; PublishedCatalogVersion=2026-09-08-v6. General execution defaults to Interactive; Scheduled execution is available only through the dedicated receipt-bound surface. Scheduled direct hard-delete is prohibited. " +
