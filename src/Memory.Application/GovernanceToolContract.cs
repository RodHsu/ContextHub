...
public static class GovernanceToolContract
{
    ...
    public const string PublishedCatalogVersion = "2026-08-29-v3";
    ...
    public const string ExecuteDescription =
        ...
        "ContractVersion=2.0; SchemaHash=6aea349c2ff0a10279603ae1d40d5c3f21c03e58d7a93d10186e6fcf19ebaa86; PublishedCatalogVersion=2026-08-29-v3. Scheduled direct hard-delete is prohibited. " +
