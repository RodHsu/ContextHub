...
public sealed class OAuthOptions
{
    ...
    public string ScheduledGovernanceResource { get; set; } = string.Empty;
    ...
    public bool IncludeIssuerInAuthorizationResponse { get; set; } = true;
    public bool ClientIdMetadataDocumentEnabled { get; set; } = true;
    public int ClientIdMetadataFetchTimeoutSeconds { get; set; } = 5;
    public int ClientIdMetadataMaxRedirects { get; set; } = 3;
    public int ClientIdMetadataMaxResponseBytes { get; set; } = 65_536;
